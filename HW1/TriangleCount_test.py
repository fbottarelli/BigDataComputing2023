...
def MR_ApproxTCwithNodeColors3(V, C):
    edgesColors = (V.mapValues(CountTriangles) # mapValues because it must applied only to values of key-value pairs
        .values() 
        .collect())
    return edgesColors
...
def main():
    ...
    print("result after flatMap:", numTriangles1.take(10))
    ...
    print("Sum of the triangle in the graph:", (C**2)*sum(numTriangles3))
